...
```{r clean, results='hide', message=FALSE, warning= FALSE, error=FALSE}
...
```{r descriptives, results='hide', message=FALSE, warning= FALSE, error=FALSE}
...
```{r lexicons, message=FALSE, warning= FALSE, error=FALSE}
...
```{r sentim, message=FALSE, warning= FALSE, error=FALSE}
...
```{r dtmconvert, message=FALSE, warning= FALSE, error=FALSE}
...
```{r topics, message=FALSE, warning= FALSE, error=FALSE}
...
```{r topics_part2, results='hide', message=FALSE, warning= FALSE, error=FALSE}
...
## Predictive Analyses
```{r predicting, message=FALSE, warning= FALSE, error=FALSE}
...
```{r visualizing_lda, results='hide', message=FALSE, warning= FALSE, error=FALSE}
...
```{r optimal_topics, results='hide', message=FALSE, warning= FALSE, error=FALSE,eval = FALSE}
